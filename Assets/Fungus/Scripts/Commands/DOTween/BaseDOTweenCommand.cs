...
{
    /// <summary>
    /// Abstract base class for DOTween commands.
    /// </summary>
    [ExecuteInEditMode]
    public abstract class BaseDOTweenCommand : Command
    {
        ...
        [Tooltip("An individual name useful for stopping DOTweens by id")]
        [SerializeField]
        protected StringData _tweenId;
        ...
        public override void OnEnter()
        {
            ...
            if (waitUntilFinished)
            {
                if (ourTween != null)
                {
                    ourTween.OnComplete(OnTweenComplete);
                }
            }
            else
            {
        ...
        public abstract Tween ExecuteTween();
